...
void FOnPitchDetected_DelegateWrapper(const FMulticastScriptDelegate& OnPitchDetected, FPitchInfo const& PitchInfo)
{
	...
	struct Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics
	{
		static const FStructRegisterCompiledInInfo ScriptStructInfo[];
		static const FClassRegisterCompiledInInfo ClassInfo[];
	};
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ScriptStructInfo[] = {
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ClassInfo[] = {
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_2723019871(TEXT("/Script/GameProject_BP"),
		Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ClassInfo),
		Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_user_Desktop_cc_copy_GameProject_BP_Source_GameProject_BP_Public_PitchDetectorComponent_h_Statics::ScriptStructInfo),
		nullptr, 0);
