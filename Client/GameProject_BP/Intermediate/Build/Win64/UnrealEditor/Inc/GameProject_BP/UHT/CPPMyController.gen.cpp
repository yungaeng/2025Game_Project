...
// End Cross Module References
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_IndicatorWidget_MetaData[];
#endif
		static const UECodeGen_Private::FObjectPropertyParams NewProp_IndicatorWidget;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UClass_ACPPMyController_Statics::NewProp_IndicatorWidget_MetaData[] = {
		{ "EditInline", "true" },
		{ "ModuleRelativePath", "Public/CPPMyController.h" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UClass_ACPPMyController_Statics::NewProp_IndicatorWidget = { "IndicatorWidget", nullptr, (EPropertyFlags)0x0040000000080008, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(ACPPMyController, IndicatorWidget), Z_Construct_UClass_UCPP_W_Indicator_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_ACPPMyController_Statics::NewProp_IndicatorWidget_MetaData), Z_Construct_UClass_ACPPMyController_Statics::NewProp_IndicatorWidget_MetaData) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_ACPPMyController_Statics::PropPointers[] = {
		...
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_ACPPMyController_Statics::NewProp_IndicatorWidget,
	};
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_2025Game_Project_Client_GameProject_BP_Source_GameProject_BP_Public_CPPMyController_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_ACPPMyController, ACPPMyController::StaticClass, TEXT("ACPPMyController"), &Z_Registration_Info_UClass_ACPPMyController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ACPPMyController), 1276732165U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_user_Desktop_2025Game_Project_Client_GameProject_BP_Source_GameProject_BP_Public_CPPMyController_h_2315764888(TEXT("/Script/GameProject_BP"),
